...
<body>
	<form action="lunch/save.do" name="Form" id="Form" method="post">
		...
		<table>
			...
			<tr>
				<td>是否上架 ：</td>
				<td>
					<input   type="radio" name="_shelves"  class="_shelves"  checked  onclick="changeShelves('1')"/>是
					<input     type="radio" name="_shelves"  class="_shelves"    onclick="changeShelves('99')"/>否
