  ...
  <div class="row-fluid">
								...
								<td>${var.chmoney}</td>
 								<td style="width: 30px;" class="center">
										 <div class='hidden-phone visible-desktop btn-group'>
											...
											<c:if test="${QX.edit == 1 }">
												<a   title="编辑" onclick="edit('${var.delivery_fee_id}');"  class="btn btn-mini btn-info"  >编辑</a>
											</c:if>
											<%-- <c:if test="${QX.del == 1 }">
												<a   title="删除" onclick="del('${var.delivery_fee_id}');"  class="btn btn-mini btn-info"  >删除</a>
											</c:if> --%>
											</div> 
 								</td>
							</tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增配送费";
			 diag.URL = '<%=basePath%>/delivery_fee/goAdd.do';
			 diag.Width = 600;
			 diag.Height = 500;
