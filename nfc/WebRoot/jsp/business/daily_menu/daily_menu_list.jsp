...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="daily_menu/list.do" method="post" name="Form" id="Form">
			<!-- 检索  -->
								...
								<td>${var.lunch_namestr}</td>
 								<td style="width: 30px;" class="center">
										 <div class='hidden-phone visible-desktop btn-group'>
											...
											<c:if test="${QX.edit == 1 }">
												<a   title="编辑" onclick="edit('${var.daily_menu_id}');"  class="btn btn-mini btn-info"  >编辑</a>
											</c:if>
											<c:if test="${QX.del == 1 }">
												<a   title="删除" onclick="del('${var.daily_menu_id}');"  class="btn btn-mini btn-info"  >删除</a>
											</c:if> 
											</div> 
 								</td>
							</tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					var url = "<%=basePath%>/daily_menu/delete.do?daily_menu_id="+Id+"&tm="+new Date().getTime();
