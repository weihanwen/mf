...
<body>
	<form action="scheduled_time/save.do" name="Form" id="Form" method="post">
		...
		<table style="width: 100%; ">
			<tr>
				<td colspan="2">销售日期 ：
					<input name="day"  id="day" value="" type="text"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"   style="width:208px;" >
				</td>
			</tr>
			<tr>
				<td colspan="2">时段名称：
			...
			<tr>
				<td colspan="2">销售时间段 ：
					<input type="time"  name="sale_starttime"  id="sale_starttime" value="00:00" type="time"  style=" width: 20%; " >
					至
					<input type="time"     name="sale_endtime"  id="sale_endtime" value="00:00" type="time"   style=" width: 20%; ">
 				</td>
 			</tr>
			<tr>
				<td colspan="2">预定时间段 ：
 					<input type="text"  class="date-picker" name="yd_starttime"  id="yd_starttime" value=""   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"    style=" width: 27%; "   >
 					至
 					<input type="text"  class="date-picker" name="yd_endtime"  id="yd_endtime" value=""  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"       style=" width: 27%; " >
				</td>
			</tr>
