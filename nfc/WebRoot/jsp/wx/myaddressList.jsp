			...
			success:function(data){
				  if(data.result == "1"){
					  ...
					  for (var int = 0; int < likeaddressList.length; int++) {
						...
						$("#listsearch").append("<span class=\"address_search\" onclick=\"openAddForSearch(\'"+array_element.contacts+"\',\'"+array_element.sex+"\',\'"+array_element.contacts_number+"\',\'"+array_element.corporate_name+"\',\'"+array_element.address_id+"\',\'"+array_element.floor_number+"\')\">"+
...
//前往新增页面
function openAddForSearch(contacts,sex,contacts_number,corporate_name,address_id,floor_number){
	$(".search").hide();
	$(".add").show();
	$(".addaddress").show();
 	...
 	$("#address_id").val(address_id);
  	$("#floor_number1").val(floor_number.split("层")[0]);
 	$("#floor_number2").val(floor_number.split("层")[1]);
 }
