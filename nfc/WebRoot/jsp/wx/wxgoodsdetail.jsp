...
<section class="twosection">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 790px;
        height: 1060px; background: #191919; overflow: hidden;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 790px; height: 860px; overflow: hidden;">
            <c:forEach items="${varList}" var="var">
            	<div>
	                <img u="image" src="${var.dc_images}" />
	                <img u="thumb" src="${var.dc_images_small}" lunch_id="${var.lunch_id}"/>
	            </div>
            </c:forEach>
         </div>
        ...
        <div u="thumbnavigator" class="jssort01" style="position: absolute; width: 800px; height: 210px; left:0px; bottom: 0px;">
            ...
            <div u="slides" style="cursor: move;">
                <div u="prototype" class="p" style="position: absolute; width: 145px; height: 145px; top: 0; left: 0;">
...
<script type="text/javascript" src="js/lunbo/jquery-2.0.0.min.js"></script>
    <!-- use jssor.slider.mini.js (40KB) instead for release -->
    <!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
    <script type="text/javascript" src="js/lunbo/jssor.js"></script>
    <script type="text/javascript" src="js/lunbo/jssor.slider.js"></script>
    <script>
