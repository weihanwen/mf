...
<script type="text/javascript">
	...
	function has(){
		...
		var url = "zidian/has.do?BIANMA="+BIANMA+"&ZD_ID="+ZD_ID+"&tm="+new Date().getTime();
...
<body>
	<form  action="zidian/save.do" name="Form" id="Form" method="post" >
		...
		<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><img src="images/jzx.gif" style="width: 50px;" /><br/><h4 class="lighter block green"></h4></div>
	</form>
</body>
<script type="text/javascript">
	var msg = '${msg}';
