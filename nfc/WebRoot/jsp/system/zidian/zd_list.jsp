	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<c:choose>
			<c:when test="${not empty varList}">
				...
				<td class='center'><a href="<%=basePath%>/zidian.do?PARENT_ID=${var.ZD_ID }" title="查看下级"><i class="icon-arrow-right  icon-on-right"></i>&nbsp;${var.NAME }</a></td>
		...
		<table style="width:100%;">
			<tr>
				...
				<c:if test="${pd.PARENT_ID != '0'}">
					<td style="vertical-align:top;" class="left"><a class="btn btn-small btn-info" onclick="location.href='<%=basePath%>/zidian.do?PARENT_ID=${pdp.PARENT_ID }';">返回</a></td>
				</c:if>
