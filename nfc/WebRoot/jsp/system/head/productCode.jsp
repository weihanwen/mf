...
<script type="text/javascript">
	...
	function saveD(){
		...
		var fields = dname + ',tianer,' + dtype + ',tianer,' + dbz + ',tianer,' + isQian + ',tianer,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',tianer,');
...
<body>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		function appendC(value){
			...
			var fieldarray = value.split(',tianer,');
		...
		function isSame(value){
			for(var i=0;i<arField.length;i++){
				var array0 = arField[i].split(',tianer,')[0];
				if(array0 == value){
					return false;
				}
			}
