...
<head>
   ...
   <body>
	...
	<div style="width:100%;height:100%;text-align: center;margin: 0 auto;position: absolute;background-image: url('<%=path %>/admin00/login/images/loginbj.jpg')">
    	 <div id="loginbox">            
            <form action="login_login.do" method="post" name="loginForm" id="loginForm" onsubmit="return check();">
      		...
      		<div class="controls">
               <div class="main_input_box">
                         	<font color="white"><span id="nameerr">©2016 jiuyuvip.com [浙] ICP备16025718号-2 ,All Rights Reserved.</span></font>
               </div>
           </div>
   		</div>
   	</div>
