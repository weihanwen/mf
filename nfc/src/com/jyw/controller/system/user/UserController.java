package com.jyw.controller.system.user;
...
import com.jyw.entity.system.Role;
...
import com.jyw.util.GetPinyin;
import com.jyw.util.MD5;
import com.jyw.util.PageData;
import com.jyw.util.PathUtil;
import com.jyw.util.Tools;
import com.jyw.util.file.FileDownload;
import com.jyw.util.file.FileUpload;
import com.jyw.util.file.ObjectExcelRead;
...
public class UserController extends BaseController {
	...
	public ModelAndView saveU(PrintWriter out) throws Exception{
		...
		pd.put("SKIN", "default");				//默认皮肤
 		pd.put("PASSWORD", MD5.md5( pd.getString("PASSWORD")));//MD5加密
 		...
 		if (null != file && !file.isEmpty()) {
			...
			for(int i=0;i<listPd.size();i++){		
				...
				pd.put("PHONE", listPd.get(i).getString("var2"));							//手机号
 				pd.put("PASSWORD", MD5.md5( pd.getString("PASSWORD")));//默认密码123
				if(userService.findByUN(pd) != null){
					continue;
				}
				userService.saveU(pd);
