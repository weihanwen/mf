package com.jyw.service.system.user;
...
public class UserService {
	...
	* 返回类型：json
	 */
	public PageData findUserDatail(String USER_ID) throws Exception {
		return (PageData) dao.findForObject("UserFMapper.findById", USER_ID);
	}
