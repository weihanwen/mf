...
@Service("daily_menuService")
public class  Daily_menuService {
	...
	*/
	public void save(PageData pd)throws Exception{
		dao.save("Daily_menuMapper.save", pd);
	}
	...
	*/
	public void delete(PageData pd)throws Exception{
		dao.delete("Daily_menuMapper.delete", pd);
	}
	...
	*/
	public void edit(PageData pd)throws Exception{
		dao.update("Daily_menuMapper.edit", pd);
	}
	...
	*/
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("Daily_menuMapper.datalistPage", page);
	}
